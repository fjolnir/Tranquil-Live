...
- (Vector2 *)add:(Vector2 *)aOther {
	return [Vector2 vectorWithVec:vec2_add(_vec, aOther.vec)];
}
- (Vector2 *)sub:(Vector2 *)aOther {
	return [Vector2 vectorWithVec:vec2_sub(_vec, aOther.vec)];
}
- (Vector2 *)mul:(Vector2 *)aOther {
	return [Vector2 vectorWithVec:vec2_mul(_vec, aOther.vec)];
}
- (Vector2 *)div:(Vector2 *)aOther {
	return [Vector2 vectorWithVec:vec2_div(_vec, aOther.vec)];
}

- (float)dot:(Vector2 *)aOther {
	return vec2_dot(_vec, aOther.vec);
}
- (float)distanceToPoint:(Vector2 *)aOther {
	return vec2_dist(_vec, aOther.vec);
}
...
- (Vector3 *)add:(Vector3 *)aOther {
	return [Vector3 vectorWithVec:vec3_add(_vec, aOther.vec)];
}
- (Vector3 *)sub:(Vector3 *)aOther {
	return [Vector3 vectorWithVec:vec3_sub(_vec, aOther.vec)];
}
- (Vector3 *)mul:(Vector3 *)aOther {
	return [Vector3 vectorWithVec:vec3_mul(_vec, aOther.vec)];
}
- (Vector3 *)div:(Vector3 *)aOther {
	return [Vector3 vectorWithVec:vec3_div(_vec, aOther.vec)];
}
- (Vector3 *)cross:(Vector3 *)aOther {
	return [Vector3 vectorWithVec:vec3_cross(_vec, aOther.vec)];
}

- (float)dot:(Vector3 *)aOther {
	return vec3_dot(_vec, aOther.vec);
}
- (float)distanceToPoint:(Vector3 *)aOther {
	return vec3_dist(_vec, aOther.vec);
}
...
+ (Vector4 *)vectorWithX:(float)aX y:(float)aY z:(float)aZ w:(float)aW {
	...
	out.vec = vec4_create(aX, aY, aZ, aW);
	return out;
}
...
- (Vector4 *)add:(Vector4 *)aOther {
	return [Vector4 vectorWithVec:vec4_add(_vec, aOther.vec)];
}
- (Vector4 *)sub:(Vector4 *)aOther {
	return [Vector4 vectorWithVec:vec4_sub(_vec, aOther.vec)];
}
- (Vector4 *)mul:(Vector4 *)aOther {
	return [Vector4 vectorWithVec:vec4_mul(_vec, aOther.vec)];
}
- (Vector4 *)div:(Vector4 *)aOther {
	return [Vector4 vectorWithVec:vec4_div(_vec, aOther.vec)];
}
- (Vector4 *)cross:(Vector4 *)aOther {
	return [Vector4 vectorWithVec:vec4_cross(_vec, aOther.vec)];
}

- (float)dot:(Vector4 *)aOther {
	return vec4_dot(_vec, aOther.vec);
}
- (float)distanceToPoint:(Vector4 *)aOther {
	return vec4_dist(_vec, aOther.vec);
}
...
- (Matrix3 *)mul:(Matrix3 *)aOther {
	return [Matrix3 matrixWithMat:mat3_mul(_mat, aOther.mat)];
}
- (Vector3 *)mulVector:(Vector3 *)aVector {
	return [Vector3 vectorWithVec:vec3_mul_mat3(aVector.vec, _mat)];
}
- (Matrix3 *)inverse {
...
+ (Matrix4 *)perspectiveMatrixWithFov:(float)aFov aspectRatio:(float)aAspect zNear:(float)aZNear zFar:(float)aZFar {
	Matrix4 *out = [[self alloc] init];
	out.mat = mat4_perspective(aFov, aAspect, aZNear, aZFar);
	return out;
}
...
+ (Matrix4 *)translationWithX:(float)x y:(float)y z:(float)z {
	Matrix4 *out = [[self alloc] init];
	out.mat = mat4_create_translation(x, y, z);
	return out;
}
+ (Matrix4 *)rotationWithAngle:(float)angle x:(float)x y:(float)y z:(float)z {
	Matrix4 *out = [[self alloc] init];
	out.mat = mat4_create_rotation(angle, x, y, z);
	return out;
}
+ (Matrix4 *)scaleWithX:(float)x y:(float)y z:(float)z {
	Matrix4 *out = [[self alloc] init];
	out.mat = mat4_create_scale(x, y, z);
	return out;
}


- (Matrix4 *)mul:(Matrix4 *)aOther {
	return [Matrix4 matrixWithMat:mat4_mul(_mat, aOther.mat)];
}
- (Vector4 *)mulVector:(Vector4 *)aVector {
	return [Vector4 vectorWithVec:vec4_mul_mat4(aVector.vec, _mat)];
}
- (Vector3 *)mulVector3:(Vector3 *)aVector isPoint:(BOOL)aIsPoint {
	return [Vector3 vectorWithVec:vec3_mul_mat4(aVector.vec, _mat, aIsPoint)];
}
- (Matrix4 *)inverse {
...
- (void)push:(Matrix4 *)aMat {
	matrix_stack_push_item(_stack, aMat.mat);
}
- (void)pop {
...
- (void)mul:(Matrix4 *)aMat {
	matrix_stack_mul_mat4(_stack, aMat.mat);
}
...
+ (Quaternion *)quaternionWithAngle:(float)aAngle x:(float)aX y:(float)aY z:(float)aZ {
	...
	out.quat = quat_createf(aAngle, aX, aY, aZ);
	return out;
}
...
+ (Quaternion *)quaternionFromMatrix4:(Matrix4 *)aMat {
	Quaternion *out = [[self alloc] init];
	out.quat = ortho_to_quat(aMat.mat);
	return out;
}
+ (Quaternion *)quaternionFromOrtho:(Matrix4 *)aMat {
	Quaternion *out = [[self alloc] init];
	out.quat = mat4_to_quat(aMat.mat);
	return out;
}
...
- (Vector4 *)rotatePoint:(Vector4 *)aPoint {
	return [Vector4 vectorWithVec:quat_rotatePoint(_quat, aPoint.vec)];
}
- (float)dot:(Quaternion *)aOther {
	return quat_dotProduct(_quat, aOther.quat);
}
- (Quaternion *)slerpWithDest:(Quaternion *)aDest t:(float)aT {
	return [Quaternion quaternionWithQuat:quat_slerp(_quat, aDest.quat, aT)];
}
@end
